    ...
    public class AppDbInitializer
    {
        public static void seed(IApplicationBuilder applicationBuilder)
        {
            ...
            var context = serviceScope.ServiceProvider.GetService<AppDbContext>();
                ...
                //Cinama
                if(!context.Cinama.Any()) {
                    context.Cinama.AddRange(new List<Cinama>()
                {
                     new Cinama()
                        {
                            Name = "Cinema 1",
                ...
                if (!context.Movie.Any()) {
                    context.Movie.AddRange(new List<Movie>()
                    {
                        ...
                        new Movie()
                        {
                            ...
                            price = 39.50, ImageURL = "http://dotnethow.net/images/movies/movie-7.jpeg", StartDate = DateTime.Now.AddDays(-10), EndDate = DateTime.Now.AddDays(-2), CinamaId = 1,
                            ProducerId = 3,
